...
const projects = [
  {
    title: "Em Construção",
    description: "Novos projetos chegando em breve. Estou trabalhando em algo incrível — fique de olho!",
    tech: [],
    liveUrl: null,
    githubUrl: null
  }
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <article key={index} className="group flex flex-col bg-[#111] rounded-3xl overflow-hidden border border-white/5 hover:border-purple-500/30 transition-all duration-300 shadow-2xl hover:-translate-y-2">
              ...
              <div className="h-56 bg-gradient-to-tr from-[#1a1a1a] to-[#1e1a2e] w-full relative flex items-center justify-center">
                <div className="flex flex-col items-center gap-3 z-10">
                  <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" className="text-purple-400/70">
                    <rect x="2" y="3" width="20" height="14" rx="2" ry="2"></rect>
                    <line x1="8" y1="21" x2="16" y2="21"></line>
                    <line x1="12" y1="17" x2="12" y2="21"></line>
                    <line x1="9" y1="9" x2="9" y2="9.01"></line>
                    <path d="M9 9h6l-1 5H10L9 9z"></path>
                    <path d="M7 7l1 2"></path>
                    <path d="M17 7l-1 2"></path>
                  </svg>
                  <span className="text-purple-400/60 text-xs font-semibold tracking-widest uppercase">Em breve</span>
                </div>
                  ...
                  <div className="flex gap-4 mt-auto">
                    {project.liveUrl && (
                      <a href={project.liveUrl} target="_blank" rel="noopener noreferrer"
                         className="flex-1 flex items-center justify-center gap-2 bg-linear-to-r from-orange-500 via-pink-500 to-purple-600 hover:opacity-90 text-white py-3 rounded-xl text-sm font-semibold transition-opacity shadow-lg">
